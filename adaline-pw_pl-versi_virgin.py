...
import pandas as pd
# matplotlib.pyplot and colors for graphing
...
class Perceptron(object):
    ...
    def __init__(self, eta=0.01, n_iter=10):
        # eta Learning Rate the higher the learning rate the more quickly the coefficients change
        self.eta = eta
        # n_iter = epochs or iterations through the data set
        self.n_iter = n_iter
    ...
    def fit(self, X, y):
        ...
        """
        # np.zeros line makes a one dimensional numpy array of 3 zeros.
...
# extract petal width and petal length
